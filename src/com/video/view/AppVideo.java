	...
	public static void main(String[] args) throws EmptyFieldsException {
		...
		do {
			...
			case 1:
				...
				do {
					...
					try {
						...
						JOptionPane.showMessageDialog(null,
								"Has de introducir un número para la cantidad de TAGs. Los caracteres "
			...
			case 2:
				...
				videosForUser.forEach((Video v) -> JOptionPane.showMessageDialog(null, v.getTittle(), "YOUR VIDEOS",
						JOptionPane.INFORMATION_MESSAGE));
